...
Partial Class EXTZ0204
    ...
    Private Sub InitializeComponent()
        ...
        'btnBack
        '
        Me.btnBack.Location = New System.Drawing.Point(688, 641)
        ...
        'btnComplate
        '
        Me.btnComplate.Location = New System.Drawing.Point(889, 641)
        ...
        Me.fbBillPay.Size = New System.Drawing.Size(681, 63)
        ...
        Me.fbBillPay_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "小計"
        Me.fbBillPay_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "消費税割合"
        Me.fbBillPay_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "外税(税額)"
        ...
        Me.fbBillPay_Sheet1.Columns.Get(3).Label = "小計"
        Me.fbBillPay_Sheet1.Columns.Get(3).Width = 92.0!
        Me.fbBillPay_Sheet1.Columns.Get(4).Label = "消費税割合"
        Me.fbBillPay_Sheet1.Columns.Get(4).Visible = False
        Me.fbBillPay_Sheet1.Columns.Get(4).Width = 88.0!
        Me.fbBillPay_Sheet1.Columns.Get(5).Label = "外税(税額)"
        ...
        Me.fbFutai.Size = New System.Drawing.Size(1649, 143)
        ...
        Me.fbFutai_Sheet1.ColumnCount = 33
        ...
        Me.fbFutai_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "内税外税"
        Me.fbFutai_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "税区分"
        Me.fbFutai_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "消費税率"
        Me.fbFutai_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "消費税"
        Me.fbFutai_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "入力摘要1"
        Me.fbFutai_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "入力摘要2"
        Me.fbFutai_Sheet1.ColumnHeader.Cells.Get(0, 13).Value = "プロジェクト"
        Me.fbFutai_Sheet1.ColumnHeader.Cells.Get(0, 14).Value = "プロジェクト" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "内訳"
        Me.fbFutai_Sheet1.ColumnHeader.Cells.Get(0, 15).Value = "コピー"
        Me.fbFutai_Sheet1.ColumnHeader.Cells.Get(0, 16).Value = "プロジェクト" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "一覧"
        ...
        Me.fbFutai_Sheet1.Columns.Get(0).Width = 69.0!
        ...
        Me.fbFutai_Sheet1.Columns.Get(1).Width = 141.0!
        ...
        Me.fbFutai_Sheet1.Columns.Get(2).Width = 127.0!
        ...
        Me.fbFutai_Sheet1.Columns.Get(3).Width = 98.0!
        ...
        Me.fbFutai_Sheet1.Columns.Get(4).Width = 98.0!
        ...
        Me.fbFutai_Sheet1.Columns.Get(5).Width = 98.0!
        ...
        Me.fbFutai_Sheet1.Columns.Get(6).Width = 74.0!
        ...
        Me.fbFutai_Sheet1.Columns.Get(7).Label = "内税外税"
        Me.fbFutai_Sheet1.Columns.Get(7).Width = 54.0!
        ...
        Me.fbFutai_Sheet1.Columns.Get(8).Label = "税区分"
        Me.fbFutai_Sheet1.Columns.Get(9).BackColor = System.Drawing.Color.FromArgb(CType(CType(246, Byte), Integer), CType(CType(234, Byte), Integer), CType(CType(210, Byte), Integer))
        NumberCellType4.DecimalPlaces = 0
        Me.fbFutai_Sheet1.Columns.Get(9).CellType = NumberCellType4
        Me.fbFutai_Sheet1.Columns.Get(9).Label = "消費税率"
        Me.fbFutai_Sheet1.Columns.Get(9).Width = 43.0!
        ...
        Me.fbFutai_Sheet1.Columns.Get(10).CellType = NumberCellType5
        Me.fbFutai_Sheet1.Columns.Get(10).Label = "消費税"
        Me.fbFutai_Sheet1.Columns.Get(10).Width = 65.0!
        Me.fbFutai_Sheet1.Columns.Get(11).Label = "入力摘要1"
        Me.fbFutai_Sheet1.Columns.Get(11).Width = 201.0!
        Me.fbFutai_Sheet1.Columns.Get(12).Label = "入力摘要2"
        Me.fbFutai_Sheet1.Columns.Get(12).Width = 201.0!
        Me.fbFutai_Sheet1.Columns.Get(13).BackColor = System.Drawing.Color.FromArgb(CType(CType(246, Byte), Integer), CType(CType(234, Byte), Integer), CType(CType(210, Byte), Integer))
        Me.fbFutai_Sheet1.Columns.Get(13).Label = "プロジェクト"
        Me.fbFutai_Sheet1.Columns.Get(13).Width = 79.0!
        Me.fbFutai_Sheet1.Columns.Get(14).BackColor = System.Drawing.Color.FromArgb(CType(CType(246, Byte), Integer), CType(CType(234, Byte), Integer), CType(CType(210, Byte), Integer))
        Me.fbFutai_Sheet1.Columns.Get(14).Label = "プロジェクト" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "内訳"
        Me.fbFutai_Sheet1.Columns.Get(14).Width = 113.0!
        ButtonCellType2.ButtonColor2 = System.Drawing.SystemColors.ButtonFace
        ButtonCellType2.Text = "下にコピー"
        Me.fbFutai_Sheet1.Columns.Get(15).CellType = ButtonCellType2
        Me.fbFutai_Sheet1.Columns.Get(15).Label = "コピー"
        Me.fbFutai_Sheet1.Columns.Get(15).Width = 64.0!
        ButtonCellType3.ButtonColor2 = System.Drawing.SystemColors.ButtonFace
        ButtonCellType3.Text = "表示"
        Me.fbFutai_Sheet1.Columns.Get(16).CellType = ButtonCellType3
        Me.fbFutai_Sheet1.Columns.Get(16).Label = "プロジェクト" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "一覧"
        Me.fbFutai_Sheet1.Columns.Get(16).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(17).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(18).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(19).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(20).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(21).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(22).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(23).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(24).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(25).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(26).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(27).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(28).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(29).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(30).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(31).Width = 64.0!
        Me.fbFutai_Sheet1.Columns.Get(32).Width = 64.0!
        ...
        Me.txtTitle1.Size = New System.Drawing.Size(278, 24)
        ...
        Me.txtTitle2.Size = New System.Drawing.Size(278, 24)
        ...
        Me.ClientSize = New System.Drawing.Size(1675, 676)
