...
Public Class SqlEXTC0102
    ...
    '                           ") values ( " & vbCrLf & _
    '                               "'S' || to_char(nextval('YOYAKU_TBL_S2'), 'FM00000'), " & vbCrLf & _
    '                               ":KariukeDt, " & vbCrLf & _
    '                               ":KariUsercd, " & vbCrLf & _
    '                               ":KakuteiDt, " & vbCrLf & _
    '                               ":KakuUsercd, " & vbCrLf & _
    ...
    '2016.11.2 MOD m.hayabuchi 課題No.58 ※予約ステータスが仮予約の場合は抽出しない(KAKUTEI_DTがNULLのため)
    'SQL文(責任者検索)
    ...
    Private strEX04S004 As String = _
                           ...
                           "order by " & vbCrLf & _
                           "    sekinin_nm "
    '2016.11.2 MOD m.hayabuchi 課題No.58
    ...
    Public Function registerYoyakuInfo(ByRef Cmd As NpgsqlCommand, _
                                   ByRef Cn As NpgsqlConnection, _
                                   ByVal dataEXTC0102 As DataEXTC0102, _
        ...
        Try
            ...
            '2016.11.4 m.hayabuchi MOD Start 課題No.59
            'Cmd.Parameters(0).Value = dataEXTC0102.PropStrKariukeDt
            'Cmd.Parameters(1).Value = dataEXTC0102.PropStrKariUsercd
            'Cmd.Parameters(2).Value = DBNull.Value
            'Cmd.Parameters(3).Value = DBNull.Value
            'Cmd.Parameters(4).Value = dataEXTC0102.PropStrYoyakuSts
            'Cmd.Parameters(5).Value = dataEXTC0102.PropStrShisetuKbn
            'Cmd.Parameters(6).Value = dataEXTC0102.PropStrStudioKbn
            'Cmd.Parameters(7).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrSaijiNm)
            'Cmd.Parameters(8).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrShutsuenNm)
            'Cmd.Parameters(9).Value = dataEXTC0102.PropStrKashiKind
            ...
            'Cmd.Parameters(14).Value = dataEXTC0102.PropStrOnkyoOpe
            'Cmd.Parameters(15).Value = dataEXTC0102.PropStrRiyoshaCd
            'Cmd.Parameters(16).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoNm)
            'Cmd.Parameters(17).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoKana)
            'Cmd.Parameters(18).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrSekininBushoNm)
            'Cmd.Parameters(19).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrSekininNm)
            'Cmd.Parameters(20).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrSekininMail)
            'Cmd.Parameters(21).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrDaihyoNm)
            'Cmd.Parameters(22).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoTel11)
            'Cmd.Parameters(23).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoTel12)
            'Cmd.Parameters(24).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoTel13)
            'Cmd.Parameters(25).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoTel21)
            'Cmd.Parameters(26).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoTel22)
            'Cmd.Parameters(27).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoTel23)
            'Cmd.Parameters(28).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoNaisen)
            'Cmd.Parameters(29).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoFax11)
            'Cmd.Parameters(30).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoFax12)
            'Cmd.Parameters(31).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoFax13)
            'Cmd.Parameters(32).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoYubin1)
            'Cmd.Parameters(33).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoYubin2)
            'Cmd.Parameters(34).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoTodo)
            'Cmd.Parameters(35).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoShiku)
            'Cmd.Parameters(36).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoBan)
            'Cmd.Parameters(37).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrRiyoBuild)
            'Cmd.Parameters(38).Value = dataEXTC0102.PropStrRiyoLvl
            'Cmd.Parameters(39).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrAiteCd)
            'Cmd.Parameters(40).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrOnkyoNm)
            'Cmd.Parameters(41).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrOnkyoTantoNm)
            'Cmd.Parameters(42).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrOnkyoTel11)
            'Cmd.Parameters(43).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrOnkyoTel12)
            'Cmd.Parameters(44).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrOnkyoTel13)
            'Cmd.Parameters(45).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrOnkyoNaisen)
            'Cmd.Parameters(46).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrOnkyoFax11)
            'Cmd.Parameters(47).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrOnkyoFax12)
            'Cmd.Parameters(48).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrOnkyoFax13)
            'Cmd.Parameters(49).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrOnkyoMail)
            'Cmd.Parameters(50).Value = DBNull.Value
            'Cmd.Parameters(51).Value = dataEXTC0102.PropStrSendKbn
            'Cmd.Parameters(52).Value = DBNull.Value
            'Cmd.Parameters(53).Value = DBNull.Value
            'Cmd.Parameters(54).Value = DBNull.Value
            'Cmd.Parameters(55).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrBiko)
            ...
            'Cmd.Parameters(67).Value = dataEXTC0102.PropStrYoyakuNo
            Cmd.Parameters(0).Value = dataEXTC0102.PropStrKariukeDt
            Cmd.Parameters(1).Value = dataEXTC0102.PropStrKariUsercd
            Cmd.Parameters(2).Value = DBNull.Value
            Cmd.Parameters(3).Value = DBNull.Value
            ...
            Cmd.Parameters(49).Value = dataEXTC0102.PropStrSendKbn
            Cmd.Parameters(50).Value = DBNull.Value
            Cmd.Parameters(51).Value = DBNull.Value
            Cmd.Parameters(52).Value = DBNull.Value
            Cmd.Parameters(53).Value = commonLogicEXT.convInsStr(dataEXTC0102.PropStrBiko)
            Cmd.Parameters(54).Value = DBNull.Value
            ...
            Cmd.Parameters(65).Value = dataEXTC0102.PropStrYoyakuNo
            '2016.11.4 m.hayabuchi MOD End 課題No.59
            '正常終了
            Return True
        Catch ex As Exception
    ...
    Public Function setSelectRiyosha(ByRef Adapter As NpgsqlDataAdapter, _
        ...
        Try
            ...
            'バインド変数の値を設定
            With Adapter.SelectCommand
                .Parameters(":RiyoshaCd").Value = strRiyoshaKana
            End With
